...
vmovapd [rbx+4032*8*0],ymm0
vmovapd [rbx+4032*8*1],ymm1
vmovapd [rbx+4032*8*2],ymm2
vmovapd [rbx+4032*8*3],ymm3
vzeroall
;---
...
mov r9d,Wb                ; R9  = Parm#4 = Atoms per Block B line (Wb)

;---
; This for old variant with series of blocks,
; new variant for one block only
;push Nb                   ; [RSP+48] = Parm#6 = Blocks per Series (Nb)
;push Hb                   ; [RSP+40] = Parm#5 = Lines per Block B (Hb)
;---
push 0                    ; This for stack alignment
push Hb                   ; Lines per block
;---
